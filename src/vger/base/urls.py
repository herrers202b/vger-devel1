...
urlpatterns = [
    ...
    path('options/list', views.OptionListView.as_view(), name='option-list'),
    ...
    #path('options/detail/<int:pk>/choice-update/<int:pk>', views.ChoiceCreate.as_view(), name='choice-create'),
    #path('options/detail/<int:pk>/choice-delete/<int:pk>', views.ChoiceCreate.as_view(), name='choice-create'),
