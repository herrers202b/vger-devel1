...
urlpatterns = [
    ...
    path('survey/<slug:surveySlug>/category/<slug:categoryPk>/question/<int:pk>/update-question/', views.QuestionUpdate.as_view(), name='question-update'),
    path('survey/<slug:surveySlug>/category/<slug:categoryPk>/question/<int:pk>/delete-question/', views.QuestionDelete.as_view(), name='question-delete'),
